...
public interface MRConfig {
  ...
  public static final String JOB_MAX_SPLIT_METAINFO_SIZE = 
    "mapreduce.job.split.metainfo.maxsize";
  public static final String JOB_INDEX_CACHE = 
    "mapreduce.job.indexcache.mb";

  public static final String MAP_INPUT_SPLITINFO =
    "mapreduce.job.map.input.splitinfo";
